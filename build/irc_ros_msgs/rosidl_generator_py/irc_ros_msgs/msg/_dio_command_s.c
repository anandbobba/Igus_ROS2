...
bool irc_ros_msgs__msg__dio_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("irc_ros_msgs.msg._dio_command.DioCommand", full_classname_dest, 40) == 0);
  }
  irc_ros_msgs__msg__DioCommand * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of DioCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("irc_ros_msgs.msg._dio_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DioCommand");
