...
bool irc_ros_msgs__msg__dio_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("irc_ros_msgs.msg._dio_state.DioState", full_classname_dest, 36) == 0);
  }
  irc_ros_msgs__msg__DioState * ros_message = _ros_message;
  {  // header
  ...
  {  // inputs
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      bool * dest = ros_message->inputs.data;
...
{
  /* NOTE(esteve): Call constructor of DioState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("irc_ros_msgs.msg._dio_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DioState");
  ...
  {  // inputs
    ...
    bool * src = ros_message->inputs.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
