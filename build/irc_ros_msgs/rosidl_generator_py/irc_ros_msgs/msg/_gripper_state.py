...
class GripperState(metaclass=Metaclass_GripperState):
    ...
    def __init__(self, **kwargs):
        ...
        self.grasped = kwargs.get('grasped', bool())
    ...
    @builtins.property
    def grasped(self):
        """Message field 'grasped'."""
        return self._grasped

    @grasped.setter
    def grasped(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'grasped' field must be of type 'bool'"
        self._grasped = value
