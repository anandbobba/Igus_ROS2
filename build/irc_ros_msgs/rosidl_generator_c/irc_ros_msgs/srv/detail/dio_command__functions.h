...
#ifndef IRC_ROS_MSGS__SRV__DETAIL__DIO_COMMAND__FUNCTIONS_H_
#define IRC_ROS_MSGS__SRV__DETAIL__DIO_COMMAND__FUNCTIONS_H_
...
/// Initialize srv/DioCommand message.
/**
...
/// Finalize srv/DioCommand message.
/**
...
/// Create srv/DioCommand message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * irc_ros_msgs__srv__DioCommand_Request__init().
...
/// Destroy srv/DioCommand message.
/**
 * It calls
 * irc_ros_msgs__srv__DioCommand_Request__fini()
...
/// Check for srv/DioCommand message equality.
/**
...
/// Initialize array of srv/DioCommand messages.
/**
...
/// Finalize array of srv/DioCommand messages.
/**
 * It calls
 * irc_ros_msgs__srv__DioCommand_Request__fini()
...
/// Create array of srv/DioCommand messages.
/**
 * It allocates the memory for the array and calls
 * irc_ros_msgs__srv__DioCommand_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/DioCommand messages.
/**
 * It calls
 * irc_ros_msgs__srv__DioCommand_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/DioCommand message array equality.
/**
...
/// Copy an array of srv/DioCommand messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * irc_ros_msgs__srv__DioCommand_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_irc_ros_msgs
...
/**
 * It calls
 * irc_ros_msgs__srv__DioCommand_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_irc_ros_msgs
...
/**
 * It allocates the memory for the array and calls
 * irc_ros_msgs__srv__DioCommand_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_irc_ros_msgs
...
/**
 * It calls
 * irc_ros_msgs__srv__DioCommand_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // IRC_ROS_MSGS__SRV__DETAIL__DIO_COMMAND__FUNCTIONS_H_
