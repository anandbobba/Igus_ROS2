...
#ifndef IRC_ROS_MSGS__SRV__DETAIL__GRIPPER_COMMAND__FUNCTIONS_H_
#define IRC_ROS_MSGS__SRV__DETAIL__GRIPPER_COMMAND__FUNCTIONS_H_
 ...
 * calls
 * irc_ros_msgs__srv__GripperCommand_Request__init().
...
/**
 * It calls
 * irc_ros_msgs__srv__GripperCommand_Request__fini()
 ...
 * irc_ros_msgs__srv__GripperCommand_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * irc_ros_msgs__srv__GripperCommand_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * irc_ros_msgs__srv__GripperCommand_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_irc_ros_msgs
...
/**
 * It calls
 * irc_ros_msgs__srv__GripperCommand_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_irc_ros_msgs
...
/**
 * It allocates the memory for the array and calls
 * irc_ros_msgs__srv__GripperCommand_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_irc_ros_msgs
...
/**
 * It calls
 * irc_ros_msgs__srv__GripperCommand_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // IRC_ROS_MSGS__SRV__DETAIL__GRIPPER_COMMAND__FUNCTIONS_H_
