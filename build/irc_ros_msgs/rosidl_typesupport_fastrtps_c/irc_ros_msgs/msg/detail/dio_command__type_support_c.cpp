...
#include "irc_ros_msgs/msg/detail/dio_command__rosidl_typesupport_fastrtps_c.h"
...
using _DioCommand__ros_msg_type = irc_ros_msgs__msg__DioCommand;

static bool _DioCommand__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _DioCommand__ros_msg_type * ros_message = static_cast<const _DioCommand__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
...
static bool _DioCommand__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _DioCommand__ros_msg_type * ros_message = static_cast<_DioCommand__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_irc_ros_msgs__msg__DioCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DioCommand__ros_msg_type * ros_message = static_cast<const _DioCommand__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _DioCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_irc_ros_msgs__msg__DioCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_irc_ros_msgs
size_t max_serialized_size_irc_ros_msgs__msg__DioCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = irc_ros_msgs__msg__DioCommand;
    is_plain =
      (
...
static size_t _DioCommand__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_irc_ros_msgs__msg__DioCommand(
...
static message_type_support_callbacks_t __callbacks_DioCommand = {
  "irc_ros_msgs::msg",
  "DioCommand",
  _DioCommand__cdr_serialize,
  _DioCommand__cdr_deserialize,
  _DioCommand__get_serialized_size,
  _DioCommand__max_serialized_size
};

static rosidl_message_type_support_t _DioCommand__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_DioCommand,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, irc_ros_msgs, msg, DioCommand)() {
  return &_DioCommand__type_support;
}
