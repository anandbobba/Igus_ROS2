...
#include "irc_ros_msgs/msg/detail/dio_state__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // inputs, outputs
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // inputs, outputs
...
using _DioState__ros_msg_type = irc_ros_msgs__msg__DioState;

static bool _DioState__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _DioState__ros_msg_type * ros_message = static_cast<const _DioState__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
...
static bool _DioState__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _DioState__ros_msg_type * ros_message = static_cast<_DioState__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: inputs
  {
    ...
    if (ros_message->inputs.data) {
      rosidl_runtime_c__boolean__Sequence__fini(&ros_message->inputs);
    }
    if (!rosidl_runtime_c__boolean__Sequence__init(&ros_message->inputs, size)) {
...
static uint32_t _DioState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_irc_ros_msgs__msg__DioState(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = irc_ros_msgs__msg__DioState;
    is_plain =
      (
...
static size_t _DioState__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_irc_ros_msgs__msg__DioState(
...
static message_type_support_callbacks_t __callbacks_DioState = {
  "irc_ros_msgs::msg",
  "DioState",
  _DioState__cdr_serialize,
  _DioState__cdr_deserialize,
  _DioState__get_serialized_size,
  _DioState__max_serialized_size
};

static rosidl_message_type_support_t _DioState__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_DioState,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, irc_ros_msgs, msg, DioState)() {
  return &_DioState__type_support;
}
