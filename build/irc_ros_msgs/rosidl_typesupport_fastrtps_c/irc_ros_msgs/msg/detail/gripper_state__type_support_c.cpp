...
#include "irc_ros_msgs/msg/detail/gripper_state__rosidl_typesupport_fastrtps_c.h"
...
using _GripperState__ros_msg_type = irc_ros_msgs__msg__GripperState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: grasped
  {
    cdr << (ros_message->grasped ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: grasped
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->grasped = tmp ? true : false;
  }
...
size_t get_serialized_size_irc_ros_msgs__msg__GripperState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GripperState__ros_msg_type * ros_message = static_cast<const _GripperState__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name grasped
  {
    size_t item_size = sizeof(ros_message->grasped);
...
static uint32_t _GripperState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_irc_ros_msgs__msg__GripperState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_irc_ros_msgs
size_t max_serialized_size_irc_ros_msgs__msg__GripperState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = irc_ros_msgs__msg__GripperState;
    is_plain =
      (
      offsetof(DataType, grasped) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _GripperState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_irc_ros_msgs__msg__GripperState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, irc_ros_msgs, msg, GripperState)() {
