...
#include "irc_ros_msgs/msg/detail/gripper_command__rosidl_typesupport_fastrtps_c.h"
...
using _GripperCommand__ros_msg_type = irc_ros_msgs__msg__GripperCommand;
...
size_t get_serialized_size_irc_ros_msgs__msg__GripperCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GripperCommand__ros_msg_type * ros_message = static_cast<const _GripperCommand__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _GripperCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_irc_ros_msgs__msg__GripperCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_irc_ros_msgs
size_t max_serialized_size_irc_ros_msgs__msg__GripperCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = irc_ros_msgs__msg__GripperCommand;
    is_plain =
      (
...
static size_t _GripperCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_irc_ros_msgs__msg__GripperCommand(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, irc_ros_msgs, msg, GripperCommand)() {
