...
{
  new (message_memory) irc_ros_msgs::srv::GripperCommand_Request(_init);
}

void GripperCommand_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<irc_ros_msgs::srv::GripperCommand_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GripperCommand_Request_message_member_array[1] = {
  {
    ...
    offsetof(irc_ros_msgs::srv::GripperCommand_Request, grip),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GripperCommand_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(irc_ros_msgs::srv::GripperCommand_Request),
...
{
  return &::irc_ros_msgs::srv::rosidl_typesupport_introspection_cpp::GripperCommand_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, irc_ros_msgs, srv, GripperCommand_Request)() {
  return &::irc_ros_msgs::srv::rosidl_typesupport_introspection_cpp::GripperCommand_Request_message_type_support_handle;
}
...
void GripperCommand_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) irc_ros_msgs::srv::GripperCommand_Response(_init);
}

void GripperCommand_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<irc_ros_msgs::srv::GripperCommand_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GripperCommand_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(irc_ros_msgs::srv::GripperCommand_Response, gripped),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GripperCommand_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(irc_ros_msgs::srv::GripperCommand_Response),
...
{
  return &::irc_ros_msgs::srv::rosidl_typesupport_introspection_cpp::GripperCommand_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, irc_ros_msgs, srv, GripperCommand_Response)() {
  return &::irc_ros_msgs::srv::rosidl_typesupport_introspection_cpp::GripperCommand_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers GripperCommand_service_members = {
  ...
  // see get_service_type_support_handle<irc_ros_msgs::srv::GripperCommand>()
...
get_service_type_support_handle<irc_ros_msgs::srv::GripperCommand>()
{
  ...
  auto service_type_support =
    &::irc_ros_msgs::srv::rosidl_typesupport_introspection_cpp::GripperCommand_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, irc_ros_msgs, srv, GripperCommand)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<irc_ros_msgs::srv::GripperCommand>();
}
