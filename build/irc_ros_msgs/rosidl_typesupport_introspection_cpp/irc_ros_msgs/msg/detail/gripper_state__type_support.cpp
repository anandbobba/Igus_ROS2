...
{
  new (message_memory) irc_ros_msgs::msg::GripperState(_init);
}

void GripperState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<irc_ros_msgs::msg::GripperState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GripperState_message_member_array[2] = {
  {
    ...
    offsetof(irc_ros_msgs::msg::GripperState, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(irc_ros_msgs::msg::GripperState, grasped),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GripperState_message_members = {
  ...
  2,  // number of fields
  sizeof(irc_ros_msgs::msg::GripperState),
...
{
  return &::irc_ros_msgs::msg::rosidl_typesupport_introspection_cpp::GripperState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, irc_ros_msgs, msg, GripperState)() {
  return &::irc_ros_msgs::msg::rosidl_typesupport_introspection_cpp::GripperState_message_type_support_handle;
}
