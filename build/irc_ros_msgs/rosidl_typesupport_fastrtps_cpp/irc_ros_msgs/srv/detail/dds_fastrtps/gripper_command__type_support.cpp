...
#include "irc_ros_msgs/srv/detail/gripper_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const irc_ros_msgs::srv::GripperCommand_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  irc_ros_msgs::srv::GripperCommand_Request & ros_message)
{
  // Member: grip
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = irc_ros_msgs::srv::GripperCommand_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const irc_ros_msgs::srv::GripperCommand_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<irc_ros_msgs::srv::GripperCommand_Request *>(
    untyped_ros_message);
...
{
  return &irc_ros_msgs::srv::typesupport_fastrtps_cpp::_GripperCommand_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, irc_ros_msgs, srv, GripperCommand_Request)() {
  return &irc_ros_msgs::srv::typesupport_fastrtps_cpp::_GripperCommand_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_irc_ros_msgs
cdr_serialize(
  const irc_ros_msgs::srv::GripperCommand_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: gripped
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  irc_ros_msgs::srv::GripperCommand_Response & ros_message)
{
  // Member: gripped
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = irc_ros_msgs::srv::GripperCommand_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const irc_ros_msgs::srv::GripperCommand_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<irc_ros_msgs::srv::GripperCommand_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &irc_ros_msgs::srv::typesupport_fastrtps_cpp::_GripperCommand_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, irc_ros_msgs, srv, GripperCommand_Response)() {
  return &irc_ros_msgs::srv::typesupport_fastrtps_cpp::_GripperCommand_Response__handle;
}
...
{
  return &irc_ros_msgs::srv::typesupport_fastrtps_cpp::_GripperCommand__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, irc_ros_msgs, srv, GripperCommand)() {
  return &irc_ros_msgs::srv::typesupport_fastrtps_cpp::_GripperCommand__handle;
}
