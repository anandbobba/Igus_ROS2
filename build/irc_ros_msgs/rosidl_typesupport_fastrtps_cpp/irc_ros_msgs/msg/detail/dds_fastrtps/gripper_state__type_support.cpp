...
#include "irc_ros_msgs/msg/detail/gripper_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const irc_ros_msgs::msg::GripperState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  irc_ros_msgs::msg::GripperState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = irc_ros_msgs::msg::GripperState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const irc_ros_msgs::msg::GripperState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<irc_ros_msgs::msg::GripperState *>(
    untyped_ros_message);
...
get_message_type_support_handle<irc_ros_msgs::msg::GripperState>()
{
  return &irc_ros_msgs::msg::typesupport_fastrtps_cpp::_GripperState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, irc_ros_msgs, msg, GripperState)() {
  return &irc_ros_msgs::msg::typesupport_fastrtps_cpp::_GripperState__handle;
}
