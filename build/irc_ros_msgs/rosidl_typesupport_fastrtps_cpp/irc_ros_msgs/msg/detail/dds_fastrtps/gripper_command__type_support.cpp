...
#include "irc_ros_msgs/msg/detail/gripper_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const irc_ros_msgs::msg::GripperCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  irc_ros_msgs::msg::GripperCommand & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = irc_ros_msgs::msg::GripperCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const irc_ros_msgs::msg::GripperCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<irc_ros_msgs::msg::GripperCommand *>(
    untyped_ros_message);
...
{
  return &irc_ros_msgs::msg::typesupport_fastrtps_cpp::_GripperCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, irc_ros_msgs, msg, GripperCommand)() {
  return &irc_ros_msgs::msg::typesupport_fastrtps_cpp::_GripperCommand__handle;
}
