...
static const _GripperState_type_support_symbol_names_t _GripperState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, irc_ros_msgs, msg, GripperState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, irc_ros_msgs, msg, GripperState)),
  }
};
...
{
  return &::irc_ros_msgs::msg::rosidl_typesupport_cpp::GripperState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, irc_ros_msgs, msg, GripperState)() {
  return get_message_type_support_handle<irc_ros_msgs::msg::GripperState>();
}
